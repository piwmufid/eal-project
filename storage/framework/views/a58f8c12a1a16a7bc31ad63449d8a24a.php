...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="container rounded shadow p-3 mb-3 d-flex" style="background-color: #31363F">
            <img src="svg/dashboard.svg" alt="dashboard" width="90px">
            <div class="container ">
                <h4 class="text-primary">Welcome to!</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Speaking <span>| Today</span></h5>
                        ...
                        <?php echo $__env->yieldContent('main-table'); ?>
...
<?php /**PATH D:\Laravel\eal\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>